...
function getArtistByIndex(array, index) {
    /* code here */
    artIndex = array[index];
    return `The artist at index ${index} is ${artIndex.name}.`
  }
...
function addArtist(array, id , name , years , genre , nationality, bio){
 newObject = {id:id, name:name, years:years, genre:genre, nationality:nationality, bio:bio};
...
addArtist(artists,
   ...
   'Web Design',
    'Black',
    'Went to an Art school but I don/t have a degree. Yet I made the lists!'
  )
...
for ( let painting of artArr) {
  if(painting > 100){
    console.log(painting);
    legendPaint.push(arr.painting);
  }
}
}
